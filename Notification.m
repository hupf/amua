                                   ...
                                   
{
    ...
    titleText = [aTitleText retain];
    descriptionText = [aDescriptionText retain];
    dismissText = [aDismissText retain];
    dismissState = aDismissState;
    yesButtonText = [aYesButtonText retain];
    noButtonText = [aNoButtonText retain];
    action = anAction;
