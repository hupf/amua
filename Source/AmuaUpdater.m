...
- (void)upgradeConfigFile
{
    ...
    // Upgrade from version 0.5.6 to 0.5.7
    ...
    // Upgrade from version 0.5.7 to 0.6
    if ([[preferences objectForKey:@"version"] isEqualToString:@"0.5.7"]) {
        // no changes
    ...
    // Upgrade from version 0.6.1 to 0.6.2
    if ([[preferences objectForKey:@"version"] isEqualToString:@"0.6.1"]) {
        // no changes
        
        [preferences setObject:@"0.6.2" forKey:@"version"];
		[preferences synchronize];
	}
